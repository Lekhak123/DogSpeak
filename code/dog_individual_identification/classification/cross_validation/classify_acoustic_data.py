...
def prepare_data(train_path, test_path):
    ...
    # Encode labels - fit only on train data
    le = LabelEncoder()
...
def save_results(results, feature_type, classes):
    """Save results as CSV and LaTeX table with dog_ids, and calculate average metrics"""
...
def main():
    ...
    for feature_type in feature_types:
        train_path = f"{base_path}/{feature_type}/test_results.csv"
